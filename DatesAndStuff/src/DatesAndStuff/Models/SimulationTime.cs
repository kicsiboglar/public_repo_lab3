...
public readonly struct SimulationTime : IEquatable<SimulationTime>, IComparable<SimulationTime>
{
    ...
    /// </summary>
    private const long _logicalDigitMask = 10000;
    ...
    {
        this._logicalTicks = value.Ticks / _logicalDigitMask * _logicalDigitMask;
    }
    ...
    {
        this._logicalTicks = Convert.ToInt64(logicalTickStr);
    }
    ...
    {
        this._logicalTicks = rawLogicalTicks;
    }
    ...
    /// </summary>
    public long TotalMilliseconds  => _logicalTicks / _logicalDigitMask;

    public SimulationTime NextMillisec => new SimulationTime((this.TotalMilliseconds + 1) * _logicalDigitMask);

    public SimulationTime PreviousMillisec => new SimulationTime( (this.TotalMilliseconds - 1) * _logicalDigitMask);

    public SimulationTime PreviousLogicalTick => new SimulationTime(this._logicalTicks - 1);

    public SimulationTime NextLogicalTick => new SimulationTime(this._logicalTicks + 1);
    ...
    public static TimeSpan operator -(SimulationTime a, SimulationTime b)
    {
        ...
        return TimeSpan.FromTicks((a.TotalMilliseconds - b.TotalMilliseconds) * _logicalDigitMask);
    }
    ...
    public static SimulationTime operator -(SimulationTime a, TimeSpan tspan)
    {
        ...
        return new SimulationTime((a.TotalMilliseconds - tspan.Ticks / _logicalDigitMask) * _logicalDigitMask);
    }
    ...
    public static long MilliSecondsFromLogicalTicks(long tick) => tick / _logicalDigitMask;
    ...
    public TimeSpan ToTimeSpan() {
        var physicalTicks = TotalMilliseconds * _logicalDigitMask;
